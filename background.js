...
Background.prototype.draw = function () {
  ...
  if (y > first) {
    this.context.drawImage(this.bg, x, y, cw, bottom-y, 0, 0, cw, bottom-y);
    this.context.drawImage(this.bg, x, 0, cw, ch - (bottom-y), 0, bottom-y, cw, ch - (bottom-y));
  } else
    this.context.drawImage(this.bg, x, y, cw, ch, 0, 0, cw, ch);
...
function BGHandler() {
  ...
  this.add = function (image, speed) {
    this.backgrounds.push(new Background(this.bgContext, this.bgWidth, this.bgHeight, image, speed));
  }
